    ...
    return (
        ...
        >
            ...
            {(currentQuestion.question_type === "multiple_choice_text" || showFeedback) && <div className={classes["overlay-content"]} id="overlay-content" style={{ zIndex: 15 }}>
                {showFeedback && (
                    <div
                        className={`feedbackMessage ${feedbackMessage === "Correct!" ? "fbmcorrect" : "fbmincorrect"
                    ...
                    <div className="questionContent">
                        ...
                        >
                            <li>
                                ...
                                >
                                    <span
                                        className={`questionTitle ${currentQuestion?.template
                                            ...
                                            <li
                                                ...
                                                className={
                                                    currentQuestion.question_type ===
                                                        ...
                                                        ? `studTaskOption ${selectedOption === option.id
                                                            ? "studTaskOptionSelected"
                                                            : ""
                                                        }`
                                                        : `studTaskImg ${selectedOption === option.id
                                                            ? "studTaskImgSelected"
                                                            : ""
                                                        }`
                                                }
